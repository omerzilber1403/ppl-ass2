...
import { isClosure, makeClosureEnv, Closure, Value, ClassT, ObjectT, isClassT, isObjectT, makeClassT, makeObjectT, isSymbolSExp } from "./L3-value";
...
const evalClass = (exp: ClassExp, env: Env): Result<ClassT> =>
    makeOk(makeClassT(exp.fields, exp.methods, env));
...
const applyProcedure = (proc: Value, args: Value[]): Result<Value> =>
    ...
    isObjectT(proc) ? applyObject(proc, args) :
